...
def main():
    try:
        ...
        teacher_timetable,classroom_timetable,timetable,classroom_workload,teacher_workload,subject_records=extract_data(Optimizer)
        class_combined_df,teacher_combined_df,classroom_combined_df,kpi_dict,a,b,c = extract_output(Optimizer)
